    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-blue-50 px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg px-4 py-3 mb-6 hover:bg-gray-50 transition-colors font-medium text-gray-700 disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {googleLoading ? (
