...
`)}`,`var value = ${t.getByIndices("input_indices")};`,`value = min(value, ${t.getByIndices("input_indices")});`,""]})},rm=(t,r)=>{ri(t.inputs),ro(t,"ReduceProd",r,(t,r)=>[`var value = ${r.type.storage}(1);`,"",`value *= ${t.getByIndices("input_indices")};`,""])},rg=(t,r)=>{ri(t.inputs),ro(t,"ReduceSum",r,(t,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${t.getByIndices("input_indices")};`,""])},ry=(t,r)=>{ri(t.inputs),ro(t,"ReduceSumSquare",r,(t,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${t.getByIndices("input_indices")}; value += t * t;`,""])},r_=(t,r,i)=>{if(0===r.length)return i;let a=1,n=1;for(let i=0;i<r.length;i++)-1===r.indexOf(i)?a*=t[i]:n*=t[i];return n<32&&a>1024},rb=(t,r)=>{r_(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?rh(t,r):t3(t,r)},r$=(t,r)=>{r_(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?rl(t,r):t4(t,r)},rv=(t,r)=>{r_(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?rd(t,r):t6(t,r)},rw=(t,r)=>{r_(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?rp(t,r):t8(t,r)},rx=(t,r)=>{r_(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?rc(t,r):t5(t,r)},rS=(t,r)=>{r_(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?rf(t,r):t7(t,r)},rk=(t,r)=>{r_(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?rm(t,r):t9(t,r)},rT=(t,r)=>{r_(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?rg(t,r):re(t,r)},rC=(t,r)=>{r_(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?ry(t,r):rt(t,r)},rI=(t,r)=>{r_(t.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?ru(t,r):rr(t,r)}}),o2=W(()=>{oG(),oZ(),o1(),rE=t=>{if(!t||0===t.length||t.length>2)throw Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(1!==t[0].dataType)throw Error("Invalid input type.")},rz=(t,r)=>{rE(t.inputs),t.compute(rn("ArgMin",{hint:r.cacheKey,inputDependencies:["rank"]},[t.inputs[0]],(t,i,a)=>{let n=[];for(let r=0;r<t.rank;r++)(a.indexOf(r)>=0||0===a.length)&&n.push(`input_indices[${r}] = 0;`);return[`${n.join(`
...
`,iE=t=>`quick_gelu_impl(${t})`,iz=(t,r)=>{let i=tx(t.inputs[0].dataType);t.compute(rQ(t.inputs[0],"QuickGelu",iE,iI(i,r.alpha),r.cacheKey,t.inputs[0].dataType))}}),o5=W(()=>{oX(),oY(),o8(),iA=t=>{if(3!==t[0].dims.length)throw Error("input should have 3 dimensions");if(![2560,5120,10240].includes(t[0].dims[2]))throw Error("hidden state should be 2560, 5120 or 10240");if(1!==t[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(t[0].dims[2]!==t[1].dims[0])throw Error("last dimension of input and bias are not the same")},iO=t=>{let r=t[0].dims.slice();r[2]=r[2]/2;let i=tA("input",t[0].dataType,t[0].dims,4),a=tA("bias",t[0].dataType,[t[0].dims[2]],4),n=tO("output",t[0].dataType,r,4),s=tm.size(r)/4,o=tw(t[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:r,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:r=>`
  ...
  ${r.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${r}>, b : vec4<${r}>) -> vec4<${r}> {
      ...
      `)},iL=t=>{iM(t,"Sub",(t,r)=>`${t}-${r}`)},iV=t=>{iM(t,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},iG=t=>{iM(t,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},iH=t=>{iM(t,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},iF=t=>{iM(t,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}}),o9=W(()=>{oG(),oX(),oZ(),oY(),ij=(t,r)=>{if(!t||t.length<1)throw Error("too few inputs");let i=t[0],a=i.dataType,n=i.dims.length;t.forEach((t,s)=>{if(0!==s){if(t.dataType!==a)throw Error("input tensors should be one type");if(t.dims.length!==n)throw Error("input tensors should have the same shape");t.dims.forEach((t,a)=>{if(a!==r&&t!==i.dims[a])throw Error("non concat dimensions must match")})}})},iK=(t,r)=>`
...
`}return t})()}
  ...
  `}}}}),ua=W(()=>{oG(),oX(),oY(),ue(),ui(),ut(),i7=(t,r)=>t?`
...
`)};
    ...
    ${t.mainStart(t$)}
    ...
    }`},getRunData:t=>({outputs:[{dims:t[0].dims,dataType:t[0].dataType}],programUniforms:[{type:12,data:Math.ceil(i/4)},{type:12,data:a}],dispatchGroup:{x:Math.ceil(i/t$/4)}})}},a5=t=>{t.inputs.length<2||0===tm.size(t.inputs[1].dims)?ik(t):t.compute(a8(t.inputs))}}),ug=W(()=>{oG(),oX(),oZ(),oY(),a7=t=>{if(!t||2!==t.length)throw Error("Gather requires 2 inputs.")},a9=(t,r)=>{let i=t[0].dims,a=t[1].dims,n=i.length,s=tm.normalizeAxis(r.axis,n),o=i.slice(0);o.splice(s,1,...a);let u=i[s],l=9===t[0].dataType?4:1,d=Math.ceil(tm.size(o)/l),p=[{type:12,data:d},{type:6,data:u},{type:12,data:s},...tS(t[0].dims,t[1].dims,o)];return{name:"Gather",shaderCache:{hint:r.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:o,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:p}),getShaderSource:r=>{let i=tA("data",t[0].dataType,t[0].dims.length,l),u=tA("inputIndices",t[1].dataType,t[1].dims.length),d=tO("output",t[0].dataType,o.length,l),p=t=>{let r=a.length,l=`var indicesIndices${t}  = ${u.type.indices}(0);`;for(let i=0;i<r;i++)l+=`${r>1?`indicesIndices${t}[${i}]`:`indicesIndices${t}`} = ${o.length>1?`outputIndices${t}[uniforms.axis + ${i}]`:`outputIndices${t}`};`;l+=`
      ...
      ${r.mainStart()}
        ${r.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        ${c}
      }`}}},ne=t=>tc({axis:t.axis}),nt=(t,r)=>{a7(t.inputs),t.compute(a9(t.inputs,r))}}),uy=W(()=>{oG(),oX(),oY(),nr=(t,r,i,a,n,s,o,u,l)=>{let d=[{type:12,data:s},{type:12,data:a},{type:12,data:n},{type:12,data:i},{type:12,data:o},{type:12,data:u},{type:12,data:l}],p=[s];return d.push(...tS(r.dims,p)),t.compute({name:"computeSliceOffsets",shaderCache:{hint:`${n.length}_${i.length}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:p,dataType:t.inputs[1].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d}),getShaderSource:t=>{let a=tA("indices_data",r.dataType,r.dims.length),s=tO("input_slice_offsets_data",12,1,1),o=[{name:"output_size",type:"u32"},{name:"batch_dims",type:"u32"},{name:"input_dims",type:"u32",length:n.length},{name:"sizes_from_slice_dims_data",type:"u32",length:i.length},{name:"num_slices_per_batch",type:"u32"},{name:"input_batch_stride",type:"u32"},{name:"num_slice_dims",type:"u32"}];return`
...
`)}
  ...
  ${r.mainStart()}
    ...
    ${_?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`}}},n5=(t,r)=>{n4(t.inputs,r),32===r.blockSize&&t.adapterInfo.isVendor("intel")&&t.adapterInfo.isArchitecture("gen-12lp")?t.compute(n8(t.inputs,r)):t.compute(n6(t.inputs,r))},n7=t=>tc(t)}),uE=W(()=>{oG(),oX(),oY(),n9=t=>{if(!t||t.length<1)throw Error("Too few inputs");if(1!==t[0].dataType&&10!==t[0].dataType)throw Error("Input type must be float or float16.");if(t.length>=2){let r=2*t[0].dims.length===t[1].dims[0];if(4===t.length&&(r=2*t[3].dims[0]===t[1].dims[0]),!r)throw Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},se=(t,r,i)=>{let a="";for(let n=r-1;n>=0;--n)a+=`
